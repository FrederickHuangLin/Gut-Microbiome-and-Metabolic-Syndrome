...
summary_template =
  list("Age" = 
       ...
       "Metabolic Syndrome Level" =
         list("No or Mild" = ~ n_perc0(metabolic_syndrome_level == "No or Mild", na_rm = TRUE),
              "Moderate" = ~ n_perc0(metabolic_syndrome_level == "Moderate", na_rm = TRUE),
              "Severe" = ~ n_perc0(metabolic_syndrome_level == "Severe", na_rm = TRUE),
