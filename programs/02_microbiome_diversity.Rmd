...
```{r}
d_alpha = alpha(family_rarefied, index = "diversity_shannon")
df_alpha = data.frame(d = d_alpha$diversity_shannon,
                      meta(family_rarefied) %>% 
...
for (i in seq_along(covariates)) {
  ...
  p = df_fig %>%
    ...
    scale_y_continuous(limits = c(min(df_fig$y), 1.1 * max(df_fig$y))) + 
  ...
  print(p)
  cat("\n \n \n")
  fig_path1 = paste0("../images/diversity/alpha_family_", covariate, ".jpeg")
  fig_path2 = paste0("../images/diversity/alpha_family_", covariate, ".pdf")
...
for (i in seq_along(covariates)) {
  ...
  cat("\n \n \n")
  # Export
  fig_path1 = paste0("../images/diversity/beta_family_", covariate, ".jpeg")
  ...
  fig_path2 = paste0("../images/diversity/beta_family_", covariate, ".pdf")
...
for (i in seq_along(covariates)) {
  ...
  print(p)
  cat("\n \n \n")
  fig_path1 = paste0("../images/diversity/alpha_genus_", covariate, ".jpeg")
  fig_path2 = paste0("../images/diversity/alpha_genus_", covariate, ".pdf")
  ggsave(filename = fig_path1, plot = p, height = 5, width = 6.25, 
         units = 'in', dpi = 300) 
  ggsave(filename = fig_path2, plot = p, height = 5, width = 6.25) 
}
...
for (i in seq_along(covariates)) {
  ...
  cat("\n \n \n")
  # Export
  fig_path1 = paste0("../images/diversity/beta_genus_", covariate, ".jpeg")
  jpeg(filename = fig_path1, height = 5, width = 6.25, res = 300, units = "in")
  plot(mod, pch = 15:16, cex.lab = 1.25, cex = 1, 
       main = label, 
       xlab = labs[1], ylab = labs[2], ylim = c(-0.4, 0.6), xaxt = "n",
  ...
  fig_path2 = paste0("../images/diversity/beta_genus_", covariate, ".pdf")
  pdf(file = fig_path2, height = 5, width = 6.25)
  plot(mod, pch = 15:16, cex.lab = 1.25, cex = 1, 
       main = label, 
       xlab = labs[1], ylab = labs[2], ylim = c(-0.4, 0.6), xaxt = "n",
